...
def build_chinese_tex_template(font_family: str = "Noto Sans CJK SC") -> TexTemplate:
    """
    ...
    template.add_to_preamble(r"\setCJKmainfont{" + font_family + "}")
    return template
