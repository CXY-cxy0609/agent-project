...
class ElectrolysisOfWaterScene(BaseScene):
    ...
    def _page_1(self, total_pages: int) -> None:
        ...
        self.add_animation(labels, animation=Succession(*[Create(label, run_time=0.5) for label in labels]), run_time=2.5)
    ...
    def _page_3(self, total_pages: int) -> None:
        ...
        self.add_animation(neg_formula, animation=Write(neg_formula), run_time=3)
        ...
        self.add_animation(neg_mol, animation=FadeIn(neg_mol), run_time=1)
        ...
        self.add_animation(pos_formula, animation=Write(pos_formula), run_time=3)
        ...
        self.add_animation(pos_mol, animation=FadeIn(pos_mol), run_time=1)
