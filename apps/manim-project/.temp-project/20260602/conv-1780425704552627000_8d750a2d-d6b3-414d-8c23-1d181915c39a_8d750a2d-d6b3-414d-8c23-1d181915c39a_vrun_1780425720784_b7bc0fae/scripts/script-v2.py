...
from manim import (
    VGroup, Text, Circle, FadeIn, Create, Indicate, Line, DashedLine, Polygon, Dot, Arrow,
    ORIGIN, RIGHT, UP, DOWN, LEFT, YELLOW, BLUE, RED, GREEN, ORANGE, WHITE, GRAY,
    FadeOut, Transform, Flash, SurroundingRectangle
)
...
class SolidGeometryExam(BaseScene):
    ...
    def _create_prism_base(self):
        ...
        hidden_edges = [("C", "D"), ("C1", "D1")]  # Adjusted for better visibility
