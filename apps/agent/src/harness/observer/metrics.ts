...
export const METRIC = {
  ...
  RAG_RETRIEVE_SUCCESS: 'rag.retrieve_success',
  RAG_RETRIEVE_FAILURE: 'rag.retrieve_failure',
  RAG_CONTEXT_TOKENS: 'rag.context_tokens',
  QA_CONTEXT_HISTORY_TOKENS: 'qa.context.history_tokens',
  QA_CONTEXT_RAG_TOKENS: 'qa.context.rag_tokens',
  QA_CONTEXT_TOTAL_TOKENS: 'qa.context.total_tokens',
